...
The synthetic mountaiun elevation profile is generated by adding two gaussian-shaped functions, similar to the test scenario from [Višnjević et al., 2018](https://doi.org/10.1017/jog.2018.82):
